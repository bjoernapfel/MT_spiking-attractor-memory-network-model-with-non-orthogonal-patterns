...
with open ('Synaptic_weights_wo0_0%overlap_dis', 'r') as f:
    line_0 = f.readlines()
...
with open ('Synaptic_weights_wo0_2%overlap_dis', 'r') as f:
    line_2 = f.readlines()
...
with open ('Synaptic_weights_wo0_4%overlap_dis', 'r') as f:
    line_4 = f.readlines()
...
with open ('Synaptic_weights_wo0_6%overlap_dis', 'r') as f:
    line_6 = f.readlines()
...
with open ('Synaptic_weights_wo0_8%overlap_dis.txt', 'r') as f:
    line_8 = f.readlines()
...
with open ('Synaptic_weights_wo0_10%overlap_dis', 'r') as f:
    line_10 = f.readlines()
