...
with open ('Capacity_dis_0%overlap', 'r') as f:
    line_0 = f.readlines()
...
with open ('Capacity_dis_2%overlap', 'r') as f:
    line_2 = f.readlines()
...
with open ('Capacity_dis_4%overlap', 'r') as f:
    line_4 = f.readlines()
...
with open ('Capacity_dis_6%overlap', 'r') as f:
    line_6 = f.readlines()
...
with open ('Capacity_dis_8%overlap.txt', 'r') as f:
    line_8 = f.readlines()
...
with open ('Capacity_dis_10%overlap', 'r') as f:
    line_10 = f.readlines()
...
barplot_annotate_brackets(combinations[0][0]-1, combinations[0][1]-1, p_value_list[0], bars, bar_plot, barh=.025, dh=.35, maxasterix=3)
barplot_annotate_brackets(combinations[1][0]-1, combinations[1][1]-1, p_value_list[1], bars, bar_plot, barh=.025, dh=.11, maxasterix=3)
barplot_annotate_brackets(combinations[2][0]-1, combinations[2][1]-1, p_value_list[2], bars, bar_plot, barh=.025, dh=.20, maxasterix=3)
barplot_annotate_brackets(combinations[4][0]-1, combinations[4][1]-1, p_value_list[4], bars, bar_plot, barh=.025, dh=.06, maxasterix=3)
barplot_annotate_brackets(combinations[5][0]-1, combinations[5][1]-1, p_value_list[5], bars, bar_plot, barh=.025, dh=.15, maxasterix=3)
barplot_annotate_brackets(combinations[9][0]-1, combinations[9][1]-1, p_value_list[9], bars, bar_plot, barh=.025, dh=.10, maxasterix=3)
barplot_annotate_brackets(combinations[14][0]-1, combinations[14][1]-1, p_value_list[14], bars, bar_plot, barh=.025, dh=.055, maxasterix=3)
