...
with open ('Capacity_0%overlap', 'r') as f:
    line_0 = f.readlines()
...
with open ('Capacity_2%overlap', 'r') as f:
    line_2 = f.readlines()
...
with open ('Capacity_6%overlap', 'r') as f:
    line_6 = f.readlines()
...
with open ('Capacity_8%overlap', 'r') as f:
    line_8 = f.readlines()
...
with open ('Capacity_10%overlap', 'r') as f:
    line_10 = f.readlines()
...
barplot_annotate_brackets(combinations[0][0]-1, combinations[0][1]-1, p_value_list[0], bars, bar_plot, barh=.025, dh=.20, maxasterix=3)
barplot_annotate_brackets(combinations[1][0]-1, combinations[1][1]-1, p_value_list[1], bars, bar_plot, barh=.025, dh=.10, maxasterix=3)
barplot_annotate_brackets(combinations[2][0]-1, combinations[2][1]-1, p_value_list[2], bars, bar_plot, barh=.025, dh=.12, maxasterix=3)
barplot_annotate_brackets(combinations[3][0]-1, combinations[3][1]-1, p_value_list[3], bars, bar_plot, barh=.025, dh=.050, maxasterix=3)
barplot_annotate_brackets(combinations[4][0]-1, combinations[4][1]-1, p_value_list[4], bars, bar_plot, barh=.025, dh=.060, maxasterix=3)
barplot_annotate_brackets(combinations[5][0]-1, combinations[5][1]-1, p_value_list[5], bars, bar_plot, barh=.025, dh=.080, maxasterix=3)
barplot_annotate_brackets(combinations[6][0]-1, combinations[6][1]-1, p_value_list[6], bars, bar_plot, barh=.025, dh=.055, maxasterix=3)
barplot_annotate_brackets(combinations[10][0]-1, combinations[10][1]-1, p_value_list[10], bars, bar_plot, barh=.025, dh=.025, maxasterix=3)
